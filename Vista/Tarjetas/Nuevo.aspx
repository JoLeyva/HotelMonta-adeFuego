<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Nuevo.aspx.cs" Inherits="waHotelMontaña.Vista.Tarjetas.Nuevo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

        <div class="container">
        <h2 class="fw-bold">Nueva Tarjeta</h2>
        <div class="mb-4">
